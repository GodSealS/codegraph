...
import { loadExtensionOverrides, loadJsonDirectories } from '../project-config';
...
export class FileWatcher {
  ...
  private handleChange(rel: string): void {
    ...
    if (!isSourceFile(rel, loadExtensionOverrides(this.projectRoot), loadJsonDirectories(this.projectRoot))) {
